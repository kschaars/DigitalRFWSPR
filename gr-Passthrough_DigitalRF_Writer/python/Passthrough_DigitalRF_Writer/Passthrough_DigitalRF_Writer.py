...
class digital_rf_channel_sink(gr.sync_block):
    ...
    def __init__(
        self,
        channel_dir = 'throwaway',
        dtype = np.complex64,
        subdir_cadence_secs = 1000,
        file_cadence_millisecs = 10000,
        ...
        gr.sync_block.__init__(
            self, name="digital_rf_channel_sink", in_sig=in_sig, out_sig= [dtype]
        )
        ...
        self._start_sample = util.parse_identifier_to_sample(
            self._start_val, self._samples_per_second, None
        )
